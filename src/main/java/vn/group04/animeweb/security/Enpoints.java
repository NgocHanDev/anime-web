...
public class Enpoints {
    public static final String[] PUBLIC_GET_ENPOINTS ={"/user/reset-password","/anime", "/anime/**", "binh-luan", "binh-luan/**","/danh-sach-yeu-thich", "/danh-sach-yeu-thich/**" };
    public static final String[] PUBLIC_POST_ENPOINTS = {"/user/change-password" ,"/user/login", "/user/signup", "binh-luan", "/danh-sach-yeu-thich"};
